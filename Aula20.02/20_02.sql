...
delete from assento where classe ='Primeira Classe' and numeroassento='k8';

/*o	Elimine os clientes que moram no endereço Olípio Costa, Rio de Janeiro – RJ ou possuem o cpf 20120120122.*/

delete from cliente where endereco='Olípio Costa, Rio de Janeiro - RJ' or cpf='20120120122';

/*o	Elimine as reservas feitas em ‘2014-12-08’.*/
delete from reserva where datareserva='2014-12-08';

/*o	Elimine os voos com em que o status é cancelado*/
