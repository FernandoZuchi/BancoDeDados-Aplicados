...
-- Recupere o parentesco dos dependentes. Elimine as linhas duplicadas.
select distinct dependente.parentesco
from dependente, empregado
where dependente.codigo_empregado = empregado.codigo_empregado;

-- Recupere o nível de graduação dos cargos. Elimine as linhas duplicadas.
select cargo.nivel_graduacao
from cargo;

-- Recupere os nomes e o sexo de todos os empregados lotados no departamento 306 cujos nomes contêm a letra “a” ordenados alfabeticamente.
select empregado.nome, empregado.sexo
from empregado, departamento
where empregado.codigo_dep = 306
order by empregado.nome asc;

-- Recupere a data de nascimento e o nome de todos os empregados do sexo feminino ordenados por data de nascimento descendentemente.
select empregado.data_nasc, empregado.nome
from empregado
